...
public class CadimTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadim_two);
        mAuth = FirebaseAuth.getInstance();
        FirebaseUser currentUser = mAuth.getCurrentUser();
        post_key = getIntent().getExtras().getString("PostKey");
        if (currentUser == null) {

            Intent loginIntent = new Intent(CadimTwo.this, LoginActivity.class);
    ...
    public void onStart() {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fabCadim2);
        if (currentUser  !=null) {
    ...
    public void validate() {
        ...
        String qnLabel = getString(R.string.cadim2Label);

        if (selectedOption.isEmpty()) {
            Toast.makeText(CadimTwo.this, "Please select a radio button", Toast.LENGTH_SHORT).show();
            valid = false;
        }
        if (valid){
            ...
            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    surveyRef.child("CadimTwo").child("Label").setValue(qnLabel);
                    surveyRef.child("CadimTwo").child("SelectedOption").setValue(selectedOption);
                    surveyRef.child("CadimTwo").child("Weight").setValue(calculatedValue)
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    Intent next = new Intent(CadimTwo.this, CadimThree.class);
            ...
            Toast.makeText(CadimTwo.this, R.string.complete_question, Toast.LENGTH_SHORT).show();
        }
    }
}
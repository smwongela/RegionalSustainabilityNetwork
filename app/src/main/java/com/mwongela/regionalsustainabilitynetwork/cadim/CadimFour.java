...
public class CadimFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadim_four);
        mAuth = FirebaseAuth.getInstance();
        FirebaseUser currentUser = mAuth.getCurrentUser();
        post_key = getIntent().getExtras().getString("PostKey");
        if (currentUser == null) {

            Intent loginIntent = new Intent(CadimFour.this, LoginActivity.class);
    ...
    public void onStart() {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fabCadim4);
        if (currentUser  !=null) {
    ...
    public void validate() {
        ...
        String qnLabel = getString(R.string.cadim4Label);

        if (selectedOption.isEmpty()) {
            Toast.makeText(CadimFour.this, "Please select a radio button", Toast.LENGTH_SHORT).show();
            valid = false;
        }
        if (valid){
            ...
            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    surveyRef.child("CadimFour").child("Label").setValue(qnLabel);
                    surveyRef.child("CadimFour").child("SelectedOption").setValue(selectedOption);
                    surveyRef.child("CadimFour").child("Weight").setValue(calculatedValue)
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    Intent next = new Intent(CadimFour.this, NoFutherQuestions.class);
            ...
            Toast.makeText(CadimFour.this, R.string.complete_question, Toast.LENGTH_SHORT).show();
        }
    }
}
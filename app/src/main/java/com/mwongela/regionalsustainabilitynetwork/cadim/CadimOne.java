...
import com.mwongela.regionalsustainabilitynetwork.can.CanTwo;

public class CadimOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadim_one);
        mAuth = FirebaseAuth.getInstance();
        FirebaseUser currentUser = mAuth.getCurrentUser();
        post_key = getIntent().getExtras().getString("PostKey");
        if (currentUser == null) {

            Intent loginIntent = new Intent(CadimOne.this, LoginActivity.class);
    ...
    public void onStart() {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fabCadim1);
        if (currentUser  !=null) {
    ...
    public void validate() {
        ...
        String qnLabel = getString(R.string.cadim1Label);

        if (selectedOption.isEmpty()) {
            Toast.makeText(CadimOne.this, "Please select a radio button", Toast.LENGTH_SHORT).show();
            valid = false;
        }
        if (valid){
            ...
            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    surveyRef.child("CadimOne").child("Label").setValue(qnLabel);
                    surveyRef.child("CadimOne").child("SelectedOption").setValue(selectedOption);
                    surveyRef.child("CadimOne").child("Weight").setValue(calculatedValue)
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    Intent next = new Intent(CadimOne.this, CadimTwo.class);
            ...
            Toast.makeText(CadimOne.this, R.string.complete_question, Toast.LENGTH_SHORT).show();
        }
    }
}
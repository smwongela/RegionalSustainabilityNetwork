...
public class CanThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = new ProgressBar(CanThree.this, null, android.R.attr.progressBarStyleLarge);
    ...
    public void validate() {
        ...
        String qnLabel = getString(R.string.can3label);

        if (selectedOption.isEmpty()) {
            Toast.makeText(CanThree.this, R.string.please_select_radio, Toast.LENGTH_SHORT).show();
            valid = false;
        }
        if (valid){
            ...
            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    surveyRef.child("CanThree").child("Label").setValue(qnLabel);
                    surveyRef.child("CanThree").child("SelectedOption").setValue(selectedOption);
                    surveyRef.child("CanThree").child("Weight").setValue(calculatedValue)
            ...
            Toast.makeText(CanThree.this, R.string.complete_question, Toast.LENGTH_SHORT).show();
        }
    }
}
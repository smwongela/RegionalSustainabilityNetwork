...
import com.mwongela.regionalsustainabilitynetwork.rsn.QuestionFive;
...
public class CanOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = new ProgressBar(CanOne.this, null, android.R.attr.progressBarStyleLarge);
    ...
    public void validate() {
        ...
        String qnLabel = getString(R.string.can1Label);

        if (selectedOption.isEmpty()) {
            Toast.makeText(CanOne.this, "Please select a radio button", Toast.LENGTH_SHORT).show();
            valid = false;
        }
        if (valid){
            ...
            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    surveyRef.child("CanOne").child("Label").setValue(qnLabel);
                    surveyRef.child("CanOne").child("SelectedOption").setValue(selectedOption);
                    surveyRef.child("CanOne").child("Weight").setValue(calculatedValue)
            ...
            Toast.makeText(CanOne.this, R.string.complete_question, Toast.LENGTH_SHORT).show();
        }
    }
}
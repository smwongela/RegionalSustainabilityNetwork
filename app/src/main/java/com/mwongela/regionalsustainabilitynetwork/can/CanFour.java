...
public class CanFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_can_four);
        mAuth = FirebaseAuth.getInstance();
        layout = findViewById(R.id.display);
        progressBar = new ProgressBar(CanFour.this, null, android.R.attr.progressBarStyleLarge);
        ...
        if (currentUser == null) {
            ...
            Intent loginIntent = new Intent(CanFour.this, LoginActivity.class);
    ...
    public void onStart() {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fabCan4);
        if (currentUser  !=null) {
    ...
    public void validate() {
        ...
        String qnLabel = getString(R.string.can4label);

        if (selectedOption.isEmpty()) {
            Toast.makeText(CanFour.this, R.string.please_select_radio, Toast.LENGTH_SHORT).show();
            valid = false;
        }
        if (valid){
            ...
            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    surveyRef.child("CanFour").child("Label").setValue(qnLabel);
                    surveyRef.child("CanFour").child("SelectedOption").setValue(selectedOption);
                    surveyRef.child("CanFour").child("Weight").setValue(calculatedValue)
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Intent next = new Intent(CanFour.this, NoFutherQuestions.class);
            ...
            Toast.makeText(CanFour.this, R.string.complete_question, Toast.LENGTH_SHORT).show();
        }
    }
}
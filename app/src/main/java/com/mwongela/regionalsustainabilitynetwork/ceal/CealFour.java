...
public class CealFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ceal_four);
        mAuth = FirebaseAuth.getInstance();
        FirebaseUser currentUser = mAuth.getCurrentUser();
        post_key = getIntent().getExtras().getString("PostKey");
        if (currentUser == null) {

            Intent loginIntent = new Intent(CealFour.this, LoginActivity.class);
    ...
    public void onStart() {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fabCeal4);
        if (currentUser  !=null) {
    ...
    public void validate() {
        ...
        String qnLabel = getString(R.string.ceal4Label);

        if (selectedOption.isEmpty()) {
            Toast.makeText(CealFour.this, "Please select a radio button", Toast.LENGTH_SHORT).show();
            valid = false;
        }
        if (valid){
            ...
            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    surveyRef.child("CealFour").child("Label").setValue(qnLabel);
                    surveyRef.child("CealFour").child("SelectedOption").setValue(selectedOption);
                    surveyRef.child("CealFour").child("Weight").setValue(calculatedValue)
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    Intent next = new Intent(CealFour.this, NoFutherQuestions.class);
            ...
            Toast.makeText(CealFour.this, R.string.complete_question, Toast.LENGTH_SHORT).show();
        }
    }
}